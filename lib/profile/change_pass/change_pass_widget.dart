...
class _ChangePassWidgetState extends State<ChangePassWidget> {
  ...
  void initState() {
    ...
    _model.repeatNewPassTextController ??= TextEditingController();
    _model.repeatNewPassFocusNode ??= FocusNode();
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('CHANGE_PASS_COMP_close_ICN_ON_TAP');
            ...
            Container(
              width: double.infinity,
              child: TextFormField(
                controller: _model.repeatNewPassTextController,
                focusNode: _model.repeatNewPassFocusNode,
                autofocus: false,
                textInputAction: TextInputAction.done,
                obscureText: !_model.repeatNewPassVisibility,
                decoration: InputDecoration(
                  isDense: true,
                  ...
                  suffixIcon: InkWell(
                    onTap: () => safeSetState(
                      () => _model.repeatNewPassVisibility =
                          !_model.repeatNewPassVisibility,
                    ),
                    focusNode: FocusNode(skipTraversal: true),
                    child: Icon(
                ...
                cursorColor: FlutterFlowTheme.of(context).primaryText,
                validator: _model.repeatNewPassTextControllerValidator
                    .asValidator(context),
              ),
            ),
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('CHANGE_PASS_ChangePassDoneButton_ON_TAP');
                  logFirebaseEvent('ChangePassDoneButton_auth');
                  ...
                  logFirebaseEvent('ChangePassDoneButton_navigate_to');
