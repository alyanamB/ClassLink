          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: FutureBuilder<StudySessionsRecord>(
                  future:
                          ...
                          child: Form(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  FutureBuilder<List<MajorsRecord>>(
                                    future: queryMajorsRecordOnce(),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDIT_SESSION_seshCourseButton_ON_TAP');
                                      logFirebaseEvent(
                                          'seshCourseButton_bottom_sheet');
                                  ...
                                  Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EDIT_SESSION_Row_qt4bqrfx_ON_TAP');
                                        logFirebaseEvent(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.seshTitleTextController ??=
                                              TextEditingController(
                                        text:
                                            columnStudySessionsRecord.seshTitle,
                                      ),
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            await widget.sessionRef!
                              ...
                              seshDescription: widget.sessionRef?.id,
                              seshTitle: widget.sessionRef?.id,
                              seshCourseMajor: widget.sessionRef?.id,
                              seshCourseNumber: widget.sessionRef?.id,
                              seshLocation: widget.sessionRef?.id,
                            ));
                            logFirebaseEvent('Button_google_analytics_event');
