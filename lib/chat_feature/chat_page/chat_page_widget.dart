...
class _ChatPageWidgetState extends State<ChatPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.chatDoc?.unreadUser == currentUserReference) {
        logFirebaseEvent('chatPage_backend_call');
  ...
  void dispose() {
    ...
    () async {
      logFirebaseEvent('CHAT_PAGE_PAGE_chatPage_ON_DISPOSE');
      logFirebaseEvent('chatPage_backend_call');
      _model.chatDocCopy = await ChatsRecord.getDocumentOnce(widget.chatRef!);
      if (_model.chatDocCopy?.unreadUser == currentUserReference) {
        logFirebaseEvent('chatPage_backend_call');
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('CHAT_arrow_back_sharp_ICN_ON_TAP');
                                ...
                                child: AuthUserStreamWidget(
                                  builder: (context) => Text(
                                    valueOrDefault<String>(
                                      functions.getOtherUsernames(
                                          columnChatsRecord.usernames.toList(),
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return Builder(
                                      builder: (context) {
                                        if (listViewChatMessagesRecord.sender ==
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'CHAT_PAGE_PAGE_Image_ylegcyy1_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Image_expand_image');
                                                                    await Navigator
                                                                        .push(
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'CHAT_PAGE_PAGE_Image_mhhgvnsz_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Image_expand_image');
                                                                    await Navigator
                                                                        .push(
                          ...
                          child: Row(
                            ...
                            children: [
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      logFirebaseEvent(
                                          'CHAT_messageTextField_ON_TEXTFIELD_SUBMI');
                                      logFirebaseEvent(
                                          'messageTextField_backend_call');
                                      ...
                                      await widget.chatRef!.update({
                                        ...createChatsRecordData(
                                          ...
                                          unreadUser: _model.chatDoc?.users
                                              .elementAtOrNull(
                                                  chatPageChatsRecord.users
                                                              .firstOrNull ==
                                                          currentUserReference
                                                      ? 1
                                                      : 0),
                                      ...
                                      logFirebaseEvent(
                                          'messageTextField_reset_form_fields');
                                      safeSetState(() {
                                        _model.messageTextFieldTextController
                                            ?.clear();
                                      });
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CHAT_PAGE_PAGE_send_ICN_ON_TAP');
                                  ...
                                  await widget.chatRef!.update({
                                    ...createChatsRecordData(
                                      lastMessage: _model
                                          .messageTextFieldTextController.text,
                                      lastMessageDT: getCurrentTimestamp,
                                      unreadUser: _model.chatDoc?.users
                                          .elementAtOrNull(chatPageChatsRecord
                                                      .users.firstOrNull ==
                                                  currentUserReference
                                              ? 1
                                              : 0),
