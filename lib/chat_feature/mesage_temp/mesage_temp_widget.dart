...
class _MesageTempWidgetState extends State<MesageTempWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MESAGE_TEMP_mesageTemp_ON_INIT_STATE');
      logFirebaseEvent('mesageTemp_firestore_query');
      _model.unreadChatList01 = await queryChatsRecordOnce(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Below are messages with tutors.',
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return Builder(
                                  builder: (context) {
                                    if (listViewChatsRecord.unreadUser ==
                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MESAGE_TEMP_Container_fifmzbd2_ON_TAP');
                                            logFirebaseEvent(
                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MESAGE_TEMP_Container_96o3p0lq_ON_TAP');
                                            logFirebaseEvent(
                                                'Container_navigate_to');
